...
const SUCURSAL_REVIEWS: Record<string, { reviews: SucursalReview[]; googleUrl: string; rating: number; count: number }> = {
  ...
  tunja: {
    ...
    count: 5,
    reviews: [
      { name: 'Juan Fernando G.', text: 'Hoy compre un iPhone 17 pro, excelente atencion de las chicas y productos totalmente originales 10/10.', rating: 5 },
      { name: 'Sol Jacome', text: 'Los visite en Unicentro Tunja y muy buenos los precios, adquiri con ellos mi 17 pro.', rating: 5 },
      { name: 'Juanita Sosa', text: 'Super recomendado, tienen todos los productos de Apple con excelentes precios y una buena atencion.', rating: 5 },
      { name: 'Valentina Rodriguez', text: 'Visite la tienda en Unicentro Tunja para ver algunas MacBook y me gusto mucho la experiencia. La atencion fue buena y me explicaron sobre los equipos. Recomendado.', rating: 5 },
      { name: 'Luis A. Rodriguez', text: 'La atencion, los precios y los equipos son los mejores. Gran experiencia.', rating: 5 },
    ],
  },
  clinica: {
    ...
    reviews: [
      ...
      { name: 'Sarai Daniela S.', text: 'Buen servicio tecnico, atencion rapida y profesional.', rating: 4 },
    ],
  },
}
